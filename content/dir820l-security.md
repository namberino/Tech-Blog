...
tags:
  ...
  - security
  - reverse engineering
excerpt: "Security analysis of a D-Link IoT device"
---
...
![](./images/dir820l-security/dir820l-binwalk-results.png)

Using the extraction feature of binwalk, we can extract the underlying SquashFS file system.

![](./images/dir820l-security/dir820l-squashfs-file-system.png)
...
![](./images/dir820l-security/dir820l-shadow-cracked.png)
...
![](./images/dir820l-security/dir820l-ncc2-sbin.png)
...
![](./images/dir820l-security/checksec-ncc2.png)
...
![](./images/dir820l-security/dir-ncc2-ping-check-screen.png)

Captured request in Burp Suite:

![](./images/dir820l-security/dir-ping-check-burp-suite.png)
...
![](./images/dir820l-security/cve-2024-51186-request-processing.png)
...
![](./images/dir820l-security/hasinjectionstring-function.png)
...
![](./images/dir820l-security/command-injection-dir-ping-cgi-wget-test.png)
...
![](./images/dir820l-security/command-injection-dir-ping-cgi-telnet-bind-shell.png)
...
![](./images/dir820l-security/ping-ccp-cancel-ping-function.png)
...
![](./images/dir820l-security/cancelPing-overflow-test.png)
...
![](./images/dir820l-security/fmk-rootfs-dir820l.png)
...
![](./images/dir820l-security/dir820l-rcs-modification-telnet.png)

Now, we can build this firmware into a `bin` file.

![](./images/dir820l-security/dir820-build-new-firmware.png)
...
![](./images/dir820l-security/dir820l-modified-fw-telnet.png)

This is the `nmap` scan of the original, unmodified firmware. 

![](./images/dir820l-security/dir820l-nmap-scan-orig-fw.png)

This is the `nmap` scan of the modified firmware. Port 9999 has been opened.

![](./images/dir820l-security/dir820l-nmap-scan-new-fw.png)
...
![](./images/dir820l-security/dir820l-backdoor-script.png)
...
![](./images/dir820l-security/dir820l-backdoor-connection.png)
...
![](./images/dir820l-security/ccp-act-set-conditional.png)
...
![](./images/dir820l-security/default-cfg-file-load-function.png)
...
![](./images/dir820l-security/set-device-settings-function.png)
...
![](./images/dir820l-security/send-event-load-rtcfg.png)
...
![](./images/dir820l-security/password-get-set-ccp-request.png)
...
![](./images/dir820l-security/var-tmp-cfg-grep-login.png)
